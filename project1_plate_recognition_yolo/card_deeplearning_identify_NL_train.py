...
def main():
    ...
    dataset = datasets.ImageFolder('./annGray', transform=transform)
    ...
    model = train(model, device, loader, optimizer, loss_func, 20)
    torch.save(model.state_dict(), './weights/last_epoch_NL_model.pt')
    print("Model saved.")
